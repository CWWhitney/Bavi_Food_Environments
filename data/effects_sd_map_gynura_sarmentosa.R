# Gynura sarmentosa (Family: Asteraceae)
# Common names: Creeping Gynura
# A medicinal and edible plant native to tropical and subtropical Asia.
# Used in traditional medicine for anti-inflammatory and antioxidant properties.
# Also cultivated as a leafy vegetable.

effects_sd_map_gynura_sarmentosa <- list(
