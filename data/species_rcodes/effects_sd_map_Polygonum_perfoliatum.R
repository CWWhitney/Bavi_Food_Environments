# effects_sd_map_Polygonum_perfoliatum.R
# Based on conservation status: Highly invasive, nutritional content: Contain flavonoids
# References: @ gillani_phyto-ecological_2024
