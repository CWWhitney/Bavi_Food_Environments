# effects_sd_map_Euodia_bodinieri.R
# Based on conservation status: Not reported, nutritional content: Contain alkaloids, like evodiamine, used in
# References: @ hao_euodiae_2025, @ xiao_traditional_2023
