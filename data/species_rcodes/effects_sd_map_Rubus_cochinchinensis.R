# effects_sd_map_Rubus_cochinchinensis.R
# Based on conservation status: Not evaluated, nutritional content: High vitamin, minerals
# References: @ buczynski_review_2024, @ clark_spontaneous_2012
