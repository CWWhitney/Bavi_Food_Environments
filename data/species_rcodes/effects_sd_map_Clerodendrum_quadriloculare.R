# effects_sd_map_Clerodendrum_quadriloculare.R
# Based on conservation status: Invansive, nutritional content: contains various phytochemicals such as flavonoids, steroids
# References: @ jonatas_pdf_2024, @ okaiyeto_traditional_2021
