# effects_sd_map_Cissus_hastata.R
# Based on conservation status: Not Invasive, nutritional content: Contian bioactive compunds such as flavonoids
# References: @ gerrath_vitaceae_2015, @ lu_recent_2018
