# effects_sd_map_Costus_speciosus.R
# Based on conservation status: Not evaluated, nutritional content: Rhizomes rich in carbohydrate
# References: @ pereira_da_silva_bioactive_2003
