# effects_sd_map_Bidens_pilosa.R
# Based on conservation status: Highly invasive, nutritional content: Rich in nutrients
# References: @huynh_study_2025, @ son_investigation_2022, @lin_complete_2020
