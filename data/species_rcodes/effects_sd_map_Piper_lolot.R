# effects_sd_map_Piper_lolot.R
# Based on conservation status: Not evaluated, nutritional content: Contains bioactive compounds with medical properties
# References: @ sen_review_2022
