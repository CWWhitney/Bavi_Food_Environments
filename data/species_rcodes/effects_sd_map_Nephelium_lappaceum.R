# effects_sd_map_Nephelium_lappaceum.R
# Based on conservation status: Not reported, nutritional content: - High in antioxidants, dietary fibers, vitamins (C, B-complex)
# References: @ afzaal_nutritional_2023, @ muhtadi_acute_2023
