# effects_sd_map_Ampelocalamus_patellaris.R
# Based on conservation status: Not invasive, nutritional content: not reported
# References: @cook_potpourri_2015, @majeed_detailed_2022, @ruiz-sanchez_diversity_2020

effects_sd_map_Ampelocalamus_patellaris <- list(
