# effects_sd_map_Zingiber_officinale.R
# Based on conservation status: yes, nutritional content: Contain gingerol, an antioxidant and anti-inflammatory compound
# References: @ chakraborty_vitro_2023

effects_sd_map_Zingiber_officinale <- list(
