# effects_sd_map_Begonia_tonkinensis.R
# Based on conservation status: Not reporetd, nutritional content: Not reported
# References: @ siregar_conservation_2017, @ tian_diversity_2018
