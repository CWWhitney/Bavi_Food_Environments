# effects_sd_map_Artemisia_vulgaris_.R
# Based on conservation status: invasive, nutritional content: rich in essential oils, flavonoid
# References: @ ekiert_significance_2020

effects_sd_map_Artemisia_vulgaris_ <- list(
