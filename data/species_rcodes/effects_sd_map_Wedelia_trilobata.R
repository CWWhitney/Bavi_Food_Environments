# effects_sd_map_Wedelia_trilobata.R
# Based on conservation status: Highly invasive, nutritional content: Contain bioactive compounds
# References: @hu_invasive_2023, @huang_effects_2022
