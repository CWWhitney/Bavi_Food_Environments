# effects_sd_map_Passiflora_foetida.R
# Based on conservation status: Invasive in some region, nutritional content: Used in traditional medicines
# References: @ song_nutritional_2018, @ undirwade_passiflora_2025
