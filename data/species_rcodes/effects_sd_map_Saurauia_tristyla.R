# effects_sd_map_Saurauia_tristyla.R
# Based on conservation status: Not evaluated, nutritional content: High vitamin c
# References: @cuong_taxonomic_2007, @ ye_medicinal_2021
