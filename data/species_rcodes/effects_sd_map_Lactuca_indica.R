# effects_sd_map_Lactuca_indica.R
# Based on conservation status: Not reported, nutritional content: - Rich in flavonoids, quinic acid derivatives
# References: @ editor_systematic_2024, @ hao_comparative_2021, @ ma_toxicity_2018

effects_sd_map_Lactuca_indica <- list(
