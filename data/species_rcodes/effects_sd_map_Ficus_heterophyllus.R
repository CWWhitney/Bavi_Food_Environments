# effects_sd_map_Ficus_heterophyllus.R
# Based on conservation status: Endangered, nutritional content: Contain bioactive compounds
# References: @ogunlaja_antioxidant_2022-1, @shi_genus_2018
