# effects_sd_map_Baccaurea_ramiflora.R
# Based on conservation status: Not reported, nutritional content: Rich in vitamin C, mineral and antioxidant
# References: @ gogoi_baccaurea_2017
...
list(SpeciesConservation = list(
  ...
  DietaryDiversity = list(
    ...
    allow_access_limited_time = list(Effect = 0.18, SD = 0.04), provide_seedlings = list(Effect = 0.25, SD = 0.04)
    ), 
