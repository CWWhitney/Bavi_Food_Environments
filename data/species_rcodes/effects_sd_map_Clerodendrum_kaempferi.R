# effects_sd_map_Clerodendrum_kaempferi.R
# Based on conservation status: Not invasive, nutritional content: contains secondary metabolites such as flavonoids and phenolic compounds
# References: @mamuaja_flavonoids_2024, @rojas-sandoval_clerodendrum_2012
