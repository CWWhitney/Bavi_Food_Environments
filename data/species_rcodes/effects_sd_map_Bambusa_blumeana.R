# effects_sd_map_Bambusa_blumeana.R
# Based on conservation status: Invasive in some areas, nutritional content: Rich in nutrients
# References: @benjamin_comprehensive_2023, @liana_bamboo_2017
