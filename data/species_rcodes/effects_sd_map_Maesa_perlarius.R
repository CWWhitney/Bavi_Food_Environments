# effects_sd_map_Maesa_perlarius.R
# Based on conservation status: Not reported, nutritional content: Anitioxidant properties
# References: @ caris_floral_2000, @ utteridge_four_2012
