# effects_sd_map_Canarium_nigrum.R
# Based on conservation status: Not invasive, nutritional content: Contain bioactive compouds
# References: @daly_burseraceae_2011, @decarlo_essential_2019, ye_medicinal_2022

effects_sd_map_Canarium_nigrum <- list(
