# effects_sd_map_Hodgsonia_macrocarpa.R
# Based on conservation status: Not reported, nutritional content: No reported
# References: @ haldhar_horticulture_2018, @ sharma_hodgsonia_1991
