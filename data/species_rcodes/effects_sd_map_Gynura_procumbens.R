# effects_sd_map_Gynura_procumbens.R
# Based on conservation status: Not reported, nutritional content: - Contains flavonoids, phenolics, antioxidants
# References: @amin_pdf_2024, @ puangpronpitag_evaluation_2010
