# effects_sd_map_Clerodendrum_chinense.R
# Based on conservation status: Harmful/invasive, nutritional content: Used in traditional medicine, low nutritional value
# References: @ odimegwu_diuretic_2023, @ rojas-sandoval_clerodendrum_2012
