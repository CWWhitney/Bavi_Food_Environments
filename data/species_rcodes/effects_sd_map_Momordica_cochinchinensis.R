# effects_sd_map_Momordica_cochinchinensis.R
# Based on conservation status: Not invasive, nutritional content: Rich in caroteniods
# References: @wilmalasiri_morphological_2015
