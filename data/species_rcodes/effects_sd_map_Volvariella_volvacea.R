# effects_sd_map_Volvariella_volvacea.R
# Based on conservation status: Not evaluated, nutritional content: High protein
# References: @ ali_volvariella_2024, @ le_new_2018
