# effects_sd_map_Peperomia_pellucida.R
# Based on conservation status: endanger, nutritional content: contains various phytochemicals such as flavonoids, steroids
# References: @ ahmad_peperomia_2023, @ ho_peperomia_2022, @ vergara-rodriguez_diversity_2017
