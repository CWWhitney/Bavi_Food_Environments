# effects_sd_map_Clausena_indica.R
# Based on conservation status: Not evaluated, nutritional content: containis essential phytochemicals, minerals, and trace minerals,
# References: @ abeysinghe_nutritive_2021
