# effects_sd_map_Schefflera_heptaphylla.R
# Based on conservation status: Not evaluated, nutritional content: Low nutritional value
# References: @ atsafack_toxicological_2015
