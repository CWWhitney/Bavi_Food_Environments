# effects_sd_map_Bischofia_javanica.R
# Based on conservation status: invasive, nutritional content: Rich nutrient contain
# References: @ indra_chemical_2013, @ susanto_immunomodulatory_2022, @ yamashita_seed_2003
