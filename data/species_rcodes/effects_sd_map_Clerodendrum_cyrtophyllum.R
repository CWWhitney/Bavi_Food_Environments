# effects_sd_map_Clerodendrum_cyrtophyllum.R
# Based on conservation status: Not reported, nutritional content: Contain bioactive compounds
# References: @ nguyen_developmental_2021
