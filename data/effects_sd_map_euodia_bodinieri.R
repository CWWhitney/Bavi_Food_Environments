# Euodia bodinieri (Family: Rutaceae)
# Common names: Bodinier’s Evodia
# A small tree species native to China and Southeast Asia.
# Known for its medicinal properties and use in traditional herbal medicine.
# Its fruits are an important food source for birds and pollinators.

effects_sd_map_euodia_bodinieri <- list(
