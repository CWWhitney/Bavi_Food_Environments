...
## Create `species_data` for the Decision Model @decision_model section 

As a last step we apply the `add_species_data.R` function to add default prior species data to our existing datasets (where missing, which is not usually the case). 
