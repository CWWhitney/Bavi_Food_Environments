...
Create a `decision_options` vector with all the decision options for the park. 
...
Use a nested list structure - each outcome contains decision options with corresponding Effect and SD values. 
